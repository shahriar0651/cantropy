...
#     # Process each file
#     for file_name, file_path in tqdm(file_dir_dict.items(), desc="Files processed"):
#         # Initialize dictionary to track missing windsizes for each feature type
#         windsizes_missing_dict = {}
#         df_windows_file = pd.DataFrame([])
...
#         print("list_of_unique_feat: ", list_of_unique_feat)
...
# #                 f_name = ensure_dir(f"{args.features_dir}/df_windows_tsfel_{dataset}_{file_name}_{per_of_samples}_{feature_type}_{windsize}.csv")
# #                 if file_exists(f_name):
# #                     print(f_name)
# #                     if load == True:
...
# #         scaler_filename = f"{args.scaler_dir}//scaler_data_{data_type}_{dataset}_{feature_type}_{windsize}.save"
...
# #         df_windows_final = pd.concat([df_windows_final, df_windows_feats], axis = 1)
# #         # f_name = ensure_dir(f"{args.features_dir}/df_windows_tsfel_{dataset}_{file_name}_{per_of_samples}_{feature_type}_{windsize}.csv")
# #         f_name = ensure_dir(f"{args.features_dir}/df_windows_tsfel_clean_{dataset}_{data_type}_{feature_type}_{windsize}.csv")
# #         df_windows_final.to_csv(f_name, index = True, header = True)
# #         print(f_name, "saved!!!")
...
# #         boxplot = var_df.boxplot()  
# #         plt.xticks(rotation = 90)
# #         plt.savefig(f"{args.plot_dir}/{dataset}/variance_box_plot_{data_type}_{dataset}_{feature_type}.jpg")
# #         plt.savefig(f"{args.plot_dir}/{dataset}/variance_box_plot_{data_type}_{dataset}_{feature_type}.pdf")
# #         plt.show()
# #         plt.show()
# #         #------------------------------------
...
# #         plt.legend([])
# #         plt.xticks(rotation = 90)
# #         plt.savefig(f"{args.plot_dir}/{dataset}/variance_line_plot_{data_type}_{dataset}_{feature_type}.jpg")
# #         plt.savefig(f"{args.plot_dir}/{dataset}/variance_line_plot_{data_type}_{dataset}_{feature_type}.pdf")
# #         plt.show()
# #         #----------------------------------- 
...
# #         sns.lineplot(count_df_total, x = 'Variance Threshold', y = 'Feature-wise Count', linestyle = '--', linewidth = '0.5', marker = 'p', markersize = '10', ax = ax)
# #         plt.grid(True)
# #         plt.savefig(f"{args.plot_dir}/{dataset}/variance_vs_feature_count_dist_{data_type}_{dataset}_{feature_type}.jpg")
# #         plt.savefig(f"{args.plot_dir}/{dataset}/variance_vs_feature_count_dist_{data_type}_{dataset}_{feature_type}.pdf")
# #         plt.show()
...
# #         plt.legend(bbox_to_anchor = (1,1), ncols = 3)
# #         plt.grid(True)
# #         plt.savefig(f"{args.plot_dir}/{dataset}/boxplot_variance_vs_feature_count_dist_{data_type}_{dataset}_{feature_type}.jpg")
# #         plt.savefig(f"{args.plot_dir}/{dataset}/boxplot_variance_vs_feature_count_dist_{data_type}_{dataset}_{feature_type}.pdf")
# #         plt.show()

# #         # --------------------
# #         sns.lineplot(count_df, x = 'Variance Threshold', y = 'Feature-wise Count', hue = 'Feature', linestyle = '--', linewidth = '0.5', marker = 'p', markersize = '10')
# #         plt.legend(bbox_to_anchor = (1,1.05), ncols = 3)
# #         plt.savefig(f"{args.plot_dir}/{dataset}/lineplot_variance_vs_feature_count_dist_{data_type}_{dataset}_{feature_type}.jpg")
